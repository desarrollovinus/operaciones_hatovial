...
$link=Conectarse();
 ...
 $nuevo_inv="insert into tbl_involucrados values ('','".$cedula."','$con','".$nombre."','".$telefono."','".$celular."','".$placa_inv."','".$color_veh."','".$marca_veh."','".$servicio_veh."','".$tipo_veh."')";
 $resultado= mysql_query($nuevo_inv,$link);

?>
<meta HTTP-EQUIV="REFRESH" content="0; url=nuevo_inv.php">