...
/*$tablaexcelacc='
        <TABLE BORDER=1 CELLSPACING=1 CELLPADDING=1 width="2000px">
			<TR align="center">
				...
				<TD width="157px" >&nbsp;<b>N. INVOLUCRADOS</b>&nbsp;</TD>
				<TD width="150px">&nbsp;<b>FECHA Y HORA CONOCIMIENTO</b>&nbsp;</TD>
				<TD width="150px">&nbsp;<b>FECHA Y HORA ATENCION</b>&nbsp;</TD>
				<TD width="150px">&nbsp;<b>FECHA Y HORA TERMINO</b>&nbsp;</TD>
				<TD>&nbsp;<b>CHOQUE CONTRA VEHICULO</b>&nbsp;</TD>
				<TD>&nbsp;<b>COHQUE CONTRA OBJ FIJO</b>&nbsp;</TD>
				<TD>&nbsp;<b>ATROPELLO</b>&nbsp;</TD>
				<TD>&nbsp;<b>VOLCAMIENTO</b>&nbsp;</TD>
				<TD>&nbsp;<b>CAIDA DEL OCUPANTE</b>&nbsp;</TD>
				<TD>&nbsp;<b>CHOQUE CONTRA SEMOVIENTE</b>&nbsp;</TD>
				<TD>&nbsp;<b>OTROS</b>&nbsp;</TD>
				<TD>&nbsp;<b>N. HERIDOS</b>&nbsp;</TD>
				<TD>&nbsp;<b>N. MUERTOS</b>&nbsp;</TD>
				<TD>&nbsp;<b>EXCESO DE VELOCIDAD</b>&nbsp;</TD>
				<TD>&nbsp;<b>IMPRUD DEL PATON</b>&nbsp;</TD>
				<TD>&nbsp;<b>IMPRUD DEL CONDUCTOR</b>&nbsp;</TD>
				<TD>&nbsp;<b>FALTA DE PRECAUCION</b>&nbsp;</TD>
				<TD>&nbsp;<b>EMBRIAGUEZ</b>&nbsp;</TD>
				<TD>&nbsp;<b>FALLAS MECANICAS</b>&nbsp;</TD>
				<TD>&nbsp;<b>NO MANTENER LA DISTANCIA</b>&nbsp;</TD>
				<TD>&nbsp;<b>SEMOVIENTE EN LA VIA</b>&nbsp;</TD>
				<TD>&nbsp;<b>ADELANTAR</b>&nbsp;</TD>
				<TD>&nbsp;<b>OTROS</b>&nbsp;</TD>
	...
	$tablaexcelacc='
        <TABLE BORDER=1 CELLSPACING=1 CELLPADDING=1 width="2000px">
			<TR align="center">
				...
				<TD width="150px">&nbsp;<b>HORA TERMINO</b>&nbsp;</TD>
				<TD>&nbsp;<b>CHOQUE CONTRA VEHICULO</b>&nbsp;</TD>
				<TD>&nbsp;<b>COHQUE CONTRA OBJ FIJO</b>&nbsp;</TD>
				<TD>&nbsp;<b>ATROPELLO</b>&nbsp;</TD>
				<TD>&nbsp;<b>VOLCAMIENTO</b>&nbsp;</TD>
...
$color_fila = "bgcolor='red'";
       ...
       /*$tablaexcelacc .="<tr><td align='center'>".$cont."</td><td align='center'>".$row["id_parte"]."</td><td>".$row["fec_pro"]."</td><td>".$row["via"]."</td><td align='center'>".$row["tramo"]."</td><td align='center'>".$row["calzada"]."</td><td align='center'>".$row["abcisa"]."</td><td align='center'>".$rowinv["0"]."</td>
           <td>".$row["fec_con"]."</td><td>".$row["fechahora_ini"]."</td>
           <td>".$row["fechahora_fin"]."</td><td align='center'>".$row["ch_contra_veh"]."</td><td align='center'>".$row["ch_contra_obj"]."</td><td align='center'>".$row["atropello"]."</td><td align='center'>".$row["volcamiento"]."</td><td align='center'>".$row["caida_del_ocu"]."</td>
           <td align='center'>".$row["ch_contra_sem"]."</td><td align='center'>".$row["otros_acc"]."</td><td align='center'>".$rowvic["0"]."</td><td align='center'>".$rowvic2["0"]."</td><td align='center'>".$row["exc_vel"]."</td>
           <td align='center'>".$row["imp_peat"]."</td><td align='center'>".$row["imp_con"]."</td><td align='center'>".$row["falta_pre"]."</td><td align='center'>".$row["embri"]."</td><td align='center'>".$row["fallas"]."</td>
           <td align='center'>".$row["no_dis"]."</td><td align='center'>".$row["sem_via"]."</td><td align='center'>".$row["ade_proh"]."</td><td align='center'>".$row["hip_otros"]."</td><td align='center'>".$rowvic3["0"]."</td><td align='center'>".$rowvic4["0"]."</td>
           <td align='center'>".$rowvic5["0"]."</td><td align='center'>".$rowvic6["0"]."</td><td align='center'>".$rowvic7["0"]."</td><td align='center'>".$rowvic8["0"]."</td><td align='center'>".$rowmuer1["0"]."</td><td align='center'>".$rowmuer2["0"]."</td>
           <td align='center'>".$rowmuer3["0"]."</td><td align='center'>".$rowmuer4["0"]."</td><td align='center'>".$rowmuer5["0"]."</td><td align='center'>".$rowmuer6["0"]."</td></tr>";*/
		$tablaexcelacc .="<tr $color_fila><td align='center'>".$cont."</td><td align='center'>".$row["id_parte"]."</td><td>".$date[0]."</td><td>".$date[1]."</td><td>".$row["via"]."</td><td align='center'>".$row["tramo"]."</td><td align='center'>".$row["calzada"]."</td><td align='center'>".$row["abcisa"]."</td><td align='center'>".$rowinv["0"]."</td>
           <td>".$hora_c[1]."</td><td>".$hora_i[1]."</td><td>".$hora_f[1]."</td><td align='center'>"
		   .$row["ch_contra_veh"]."</td><td align='center'>".$row["ch_contra_obj"]."</td><td align='center'>".$row["atropello"]."</td><td align='center'>".$row["volcamiento"]."</td><td align='center'>".$row["caida_del_ocu"]."</td><td align='center'>".$row["ch_contra_sem"]."</td><td align='center'>".$row["otros_acc"]."</td><td align='center'>"
		   .$rowvic["0"]."</td><td align='center'>".$rowvic2["0"]."</td><td align='center'>".
		   $row["exc_vel"]."</td><td align='center'>".$row["imp_peat"]."</td><td align='center'>".$row["imp_con"]."</td><td align='center'>".$row["falta_pre"]."</td><td align='center'>".$row["embri"]."</td><td align='center'>".$row["fallas"]."</td><td align='center'>".$row["no_dis"]."</td><td align='center'>".$row["sem_via"]."</td><td align='center'>".$row["ade_proh"]."</td><td align='center'>".$row["hip_otros"].
		   "</td><td align='center'>".$rowvic3["0"]."</td><td align='center'>".$rowvic4["0"]."</td>
           <td align='center'>".$rowvic5["0"]."</td><td align='center'>".$rowvic6["0"]."</td><td align='center'>".$rowvic7["0"]."</td><td align='center'>".$rowvic8["0"]."</td><td align='center'>".$rowmuer1["0"]."</td><td align='center'>".$rowmuer2["0"]."</td>
           <td align='center'>".$rowmuer3["0"]."</td><td align='center'>".$rowmuer4["0"]."</td><td align='center'>".$rowmuer5["0"]."</td><td align='center'>".$rowmuer6["0"]."</td></tr>";   
