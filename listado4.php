...
<?php
   ...
   <?php $link=Conectarse();
    ...
    $fec2=$_POST['seg_fec'];
        ...
        list($year,$mon,$day) = explode('-',$fec2);
	$fec3= date('Y-m-d',mktime(0,0,0,$mon,$day+1,$year));
        $result=mysql_query("select * from tbl_bitacora where fechahora between'".$fec1."' and '".$fec3."' order by consecutivo desc",$link);
?>
    <center>
    <form  name="form4" id="form4" enctype="multipart/form-data" method="post" >
        ...
        <input style="font-size:12px;color:#ffffff;font-family:verdana;background-color:#006699;" type="button" onClick="location=document.form4.menu.options[document.form4.menu.selectedIndex].value;" value="Ir">
