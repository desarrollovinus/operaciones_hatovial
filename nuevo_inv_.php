...
<form action="inv_ins1.php" name="forminvol1" id="forminvol1" enctype="multipart/form-data" method="post" >
    ...
    <div id="contenedor_inv">
                        ...
                        <div class="campo_inv"><input type="submit" name="nuevo" id="nuevo" value="Guardar" class="botones">
                        <input type="button" name="next" id="next" value="Cancelar" onclick="location.href='selc_inv.php'" class="botones"></div>
