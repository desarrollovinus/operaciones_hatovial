...
<?php
   ...
   ?>
   <?php $link=Conectarse(); ?>
   <?php $result=mysql_query("select * from tbl_bitacora order by consecutivo desc limit 0, 100",$link);
...
?>
    ...
    <div id="botonera">
    <input type="button" id="reg" name="reg" value="Regresar" onclick="location.href='menu_insp.php'" class="button">
    </div>
